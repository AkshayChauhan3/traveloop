      ...
      <div className="p-6 lg:p-8 space-y-8">
        ...
        >
          <div className="absolute inset-0 opacity-10"
            style={{ background: 'radial-gradient(ellipse at 80% 50%, rgba(124,58,237,1), transparent 60%)' }}
          />
          <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <p className="text-slate-400 text-sm mb-1">Good morning ✨</p>
              <h1 className="text-2xl font-bold text-white mb-1">Welcome back, Sneh!</h1>
              <p className="text-slate-400">You have <span className="text-brand-400 font-semibold">3 upcoming trips</span> and <span className="text-amber-400 font-semibold">1 ongoing adventure</span>.</p>
            </div>
            <Link to="/create-trip">
              <motion.button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            ...
            {ongoingTrip ? (
              ...
              >
                ...
                <div className="p-5">
                  <h3 className="text-white font-bold text-lg mb-1">{ongoingTrip.name}</h3>
              ...
              <div className="glass-card p-8 text-center">
                <p className="text-slate-400">No ongoing trips</p>
              </div>
            )}
          </div>
          ...
          <div>
            ...
            >
              <div className="absolute inset-0 opacity-10"
                style={{ background: 'radial-gradient(circle at 50% 0%, rgba(124,58,237,1), transparent 70%)' }}
              />
              <div className="relative z-10 flex flex-col h-full">
                ...
                <h3 className="text-white font-bold text-lg mb-2">AI Trip Optimizer</h3>
            ...
            {topDests.map((dest, i) => (
              ...
              >
                <div className="relative h-32 overflow-hidden rounded-t-xl">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-surface-100/80 to-transparent" />
            ...
            {upcomingTrips.map((trip, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-white font-semibold text-sm truncate">{trip.name}</h3>
                  <p className="text-slate-400 text-xs">{trip.destinations[0]} · {trip.duration} days</p>
                </div>
                <div className="text-right flex-shrink-0">
                  <p className="text-brand-400 text-sm font-semibold">{formatCompact(trip.budget)}</p>
